            ...
            <form action="{{ route('admin.pricing.update', $pricing) }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <select name="type"
                        ...
                        @foreach (['website', 'document', 'presentation'] as $type)
                            <option value="{{ $type }}" {{ $pricing->type == $type ? 'selected' : '' }}>
                                {{ ucfirst($type) }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <div class="mt-1 relative rounded-md shadow-sm">
                        ...
                        <input type="number" name="price" step="0.01" value="{{ old('price', $pricing->price) }}"
                ...
                <div>
                    ...
                    <input type="text" name="button_text" value="{{ old('button_text', $pricing->button_text) }}"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                </div>
